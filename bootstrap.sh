...
//192.168.0.12/homes/brooks/DONJJANG /home/qtumai/jason/nas cifs credentials=/home/qtumai/.naspassword,rw 0 0
EOL
echo "/etc/fstab 수정"

# 2. '마운트시킬 NAS 경로'와 '로컬에서 해당 경로의 파일을 확인할수 있는 destination 경로'를 생성한다
mkdir -p /home/qtumai/jason/nas
echo "NAS접근용 폴더 생성"

# 3. 비밀번호 파일생성(파일명무관) 및 접속할 계정정보 입력
cat > /home/qtumai/.naspassword <<EOL
username=admin
password=@!Chaos123
EOL
echo "NAS계정정보 키생성"
